<script setup>
import { ref, defineEmits, defineProps, onMounted, onBeforeMount, onUnmounted } from 'vue';
                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="postCreate()">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="content" rows="3" placeholder="Enter the content"
