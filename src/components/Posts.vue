<script setup>
import { ref, defineProps, computed, defineEmits, inject, onUpdated } from 'vue'
        ...
        <div class="col-md-4" v-for="(post, index) in reversedPosts" :key="post.id">
          <div class="card mb-4">
            <div class="card-body">
              ...
              <CommentSection :post="post" :index="reversedPosts.length - (index + 1)"
              ...
              <button class="btn btn-sm btn-danger float-end" @click="deletePost(reversedPosts.length - (index + 1))">
